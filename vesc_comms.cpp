...
void vesc_comms::setCurrent(float currentInAmps)
{
    int32_t idx = 0;
    ...
    int32_t currentInMilliampere = (int32_t)(currentInAmps * 1000);
    buffer_append_int32(payload, currentInMilliampere, &idx);
